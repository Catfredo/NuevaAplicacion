...
router.post('/edit/:Id_task', isLoggedIn, async (req, res) => {     const { Id_task } = req.params;     const { taskname, body_task, duedate } = req.body;  
const currentDate = duedate ? new Date(duedate) : new Date();     const updatedNota = {taskname, body_task, duedate:currentDate, 
